...
urchin_stats
```
Based on the table and graphs above, we see that purple urchins have a narrower size distribution and a lower mean size compared to red urchins. The histograms show a fairly normal distribution for red urchins and a narrower, close to normal distribution for purple urchins, but with a positive tail. The standard deviation numbers from our table also demonstrate that the red urchin sample population has a greater spread of sizes compared to the purple urchin sample population. Specifically, the red urchins also have an average diameter 51.68% larger than the purple urchins, or 2.31cm bigger.
